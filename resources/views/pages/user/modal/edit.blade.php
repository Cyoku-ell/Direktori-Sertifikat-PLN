<div id="editUserModal" class="fixed inset-0 z-50 hidden bg-black/50 flex items-center justify-center overflow-y-auto">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input id="edit_username" type="text" readonly
                        ...
                        <div>
                            ...
                            <input id="edit_email" name="email" type="email" class="w-full mt-2 rounded-xl">
                        ...
                        <div>
                            ...
                            <input id="edit_perner" name="perner" type="text" class="w-full mt-2 rounded-xl">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select id="edit_unit_id" name="unit_id" class="w-full mt-2 rounded-xl">
                        ...
                        <div>
                            ...
                            <select id="edit_position_id" name="position_id" class="w-full mt-2 rounded-xl">
                        ...
                        <div>
                            ...
                            <select id="edit_status" name="status" class="w-full mt-2 rounded-xl">
                        ...
                        <div>
                            ...
                            <select id="edit_role" name="role" class="w-full mt-2 rounded-xl">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input id="edit_password" name="password" type="password"
                                placeholder="Kosongkan jika tidak diubah" class="w-full mt-2 rounded-xl">
